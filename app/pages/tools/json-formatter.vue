  ...
  <div class="space-y-6">
      ...
      <CardContent>
        <div class="flex flex-wrap gap-3">
          ...
          <div class="flex items-center gap-2 ml-auto">
            <label class="text-sm text-gray-400">缩进大小:</label>
            <select
              v-model="indentSize"
              class="px-3 py-1 bg-gray-800 border border-gray-700 rounded text-gray-100 text-sm"
            >
              <option :value="2">
                2 空格
              </option>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card class="bg-gray-900 border-gray-800">
        ...
        <CardContent>
          <Textarea
            ...
            class="min-h-[400px] font-mono text-sm bg-gray-800 border-gray-700 text-gray-100 placeholder-gray-500"
          />
        </CardContent>
      </Card>
      ...
      <Card class="bg-gray-900 border-gray-800">
        <CardHeader>
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <Badge
                v-if="inputJson.trim()"
                :class="isValid ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'"
              >
                {{ isValid ? '有效' : '无效' }}
              </Badge>
            </div>
        ...
        <CardContent>
          <!-- 错误信息 -->
          <div v-if="!isValid && errorMessage" class="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg">
