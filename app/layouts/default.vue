...
<template>
  <div class="min-h-screen bg-gray-950">
    ...
    <!-- 底部导航 -->
    <nav class="fixed bottom-0 left-0 right-0 bg-black/20 backdrop-blur-md border-t border-white/10">
      <div class="flex justify-around items-center h-16 px-4">
        ...
        <NuxtLink to="/services" class="flex flex-col items-center gap-1 text-white/70 hover:text-white transition-colors">
